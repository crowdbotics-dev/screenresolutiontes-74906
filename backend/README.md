...
## Project Structure
    ...
    ├── screenresolutiontes_74906  # Django project configurations
...
1. Clone this repo and `cd screenresolutiontes_74906`
...
2. Clone this repo and `cd screenresolutiontes_74906`
